...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(41, 41, 41)
                .addComponent(sueldom, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE", "CARGO", "SUELDO MINIMO", "HORAS EXTRAS", "ISR", "IGSS", "Sueldo Bruto"
            }
        ));
    ...
    private void CALCULARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CALCULARActionPerformed
        ...
        String nom,car;
        float suelmin,horex;
        float is = 0,ig = 0,suelbruto;
        float newsuel,newis,newig;
        
        nom=nombre.getText();
        car=cargo.getText();
        suelmin=Float.parseFloat(sueldom.getText());
     
        
        if(suelmin<2825.10){
               JOptionPane.showMessageDialog(null,"sueldo invalido");
        }
        if(is>=8000.00||is<=9500){
            is=((suelmin*6)/100);
        }
        if(ig>=9500){
            ig=((suelmin*9)/100);
        ...
        is=(suelmin*5)/100;
      ig=(float) ((suelmin*4.83)/100);
       
     horex=(float) ((suelmin*1.5)/100);      
          if(suelmin>=6000||suelmin<=8000){
          newsuel=(float) (suelmin*0.05);
          suelmin=suelmin-newsuel;
      }
          suelbruto=suelmin+is+ig;
